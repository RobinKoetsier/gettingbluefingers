...
```{=html}
<center><a href="img/1-1.png" target="_blank"><img src="img/1-1.png" height="300" width="600" class="imageContainer"></a></center>
```
...
So in the title of the plot, I put the team name with <code>glue::glue()</code>. You may have to install this package. Of course you can add more stuff to the plot, like the team loge or the number of shots. Go wild!
