...
df1 <- readxl::read_excel("Export_TDL_NED_2223-feb.xlsx", 
                   sheet = "Wedstrijden") %>%
...
df2 <- readxl::read_excel("Export_TDL_NED_2223-feb.xlsx", 
                   sheet = "Wedstrijden") %>%
...
xRank <- readxl::read_excel("Export_TDL_NED_2223-feb.xlsx", 
                  sheet = "Stand")# %>% 
#  mutate(Form = NA)
